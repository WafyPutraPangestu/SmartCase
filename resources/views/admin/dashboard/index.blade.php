                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900 mt-2" x-text="stats.totals?.tickets || 0"></p>
                                </div>
                            ...
                            <div class="mt-4 flex items-center text-sm">
                                <span class="text-success-600 font-medium" x-text="'+' + (stats.recent_activity?.new_tickets || 0)"></span>
                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900 mt-2" x-text="stats.totals?.users || 0"></p>
                                </div>
                            ...
                            <div class="mt-4 flex items-center text-sm">
                                <span class="text-success-600 font-medium" x-text="'+' + (stats.recent_activity?.new_users || 0)"></span>
                                <span class="text-gray-600 ml-2">baru hari ini</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-900 mt-2" x-text="stats.ml_stats?.total_predicted || 0"></p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.status?.Menunggu || 0"></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.status?.Diproses || 0"></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.status?.Selesai || 0"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.priority?.Tinggi || 0"></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <span class="w-3 h-3 rounded-full bg-warning-500 mr-3"></span>
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.priority?.Sedang || 0"></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <span class="w-3 h-3 rounded-full bg-success-500 mr-3"></span>
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.priority?.Rendah || 0"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <template x-for="ticket in stats.recent_tickets" :key="ticket.id">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="text-sm font-medium text-gray-900" x-text="ticket.kode_tiket"></span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-1">
                                                <span class="text-sm font-medium text-gray-700" x-text="item.kategori_gangguan_nama"></span>
                                                <span class="text-sm font-bold text-gray-900" x-text="item.total"></span>
                                            </div>
                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                <div class="bg-primary-500 h-2 rounded-full transition-all duration-500" 
                                                     :style="`width: ${(item.total / (stats.totals?.tickets || 1) * 100)}%`"></div>
                                            </div>
                                        </div>
                                    </div>
                                </template>
                        ...
                        <div class="card-body">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-lg font-bold text-gray-900" x-text="stats.ml_stats?.total_predicted || 0"></span>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-success-50 rounded-lg border border-success-200">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-success-700">High Confidence (≥70%)</span>
                                    </div>
                                    <span class="text-lg font-bold text-success-900" x-text="stats.ml_stats?.high_confidence || 0"></span>
                                </div>

                                <!-- Low Confidence -->
                                <div class="flex items-center justify-between p-3 bg-warning-50 rounded-lg border border-warning-200">
                                    <div class="flex items-center">
                                    ...
                                    <span class="text-lg font-bold text-warning-900" x-text="stats.ml_stats?.low_confidence || 0"></span>
                                </div>
                                ...
                                <div class="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-blue-700 mt-1">Model akan otomatis retrain setiap 500 prediksi untuk meningkatkan akurasi.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
