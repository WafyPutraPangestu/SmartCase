        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h1 class="text-3xl font-bold text-gray-900">Detail Kategori Pelanggan</h1>
                        <p class="text-gray-600 mt-1">Informasi lengkap tentang kategori pelanggan</p>
                    </div>
                </div>
                <span class="badge badge-primary text-base px-4 py-2">ID: #{{ $kategori->id }}</span>
            </div>
        </div>
        ...
        <div x-show="showDeleteModal" 
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6"
                    ...
                    <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus kategori pelanggan "<strong>{{ $kategori->nama_kategori }}</strong>"? Tindakan ini tidak dapat dibatalkan.</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="flex items-center p-6 bg-gradient-to-r from-primary-50 to-primary-100 rounded-lg border-l-4 border-primary-500">
                            ...
                            <div class="ml-6">
                                <label class="text-sm font-medium text-primary-600 uppercase tracking-wide">Nama Kategori</label>
                                <p class="text-2xl font-bold text-gray-900 mt-1">{{ $kategori->nama_kategori }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">
                                        {{ $kategori->created_at->format('d F Y') }} pukul {{ $kategori->created_at->format('H:i') }} WIB
                                    </p>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">
                                        {{ $kategori->updated_at->format('d F Y') }} pukul {{ $kategori->updated_at->format('H:i') }} WIB
                                    </p>
                                    <p class="text-xs text-gray-500 mt-1">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-sm">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="font-semibold text-gray-900">#{{ $kategori->id }}</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-sm">
                                <div class="flex-shrink-0 w-10 h-10 rounded-full bg-success-100 flex items-center justify-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="font-semibold text-success-600">Aktif</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-sm">
                                <div class="flex-shrink-0 w-10 h-10 rounded-full bg-warning-100 flex items-center justify-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-xs text-gray-500">Panjang Nama</p>
                                    <p class="font-semibold text-gray-900">{{ strlen($kategori->nama_kategori) }} karakter</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-sm">
                                <div class="flex-shrink-0 w-10 h-10 rounded-full bg-secondary-100 flex items-center justify-center">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="font-semibold text-gray-900">{{ $kategori->created_at->diffInDays(now()) }} hari</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-3">
                        <a href="{{ route('kategori_pelanggan.edit', $kategori->id) }}" 
                        ...
                        <form id="delete-form" 
                              action="{{ route('kategori_pelanggan.destroy', $kategori->id) }}" 
                              method="POST" 
                              class="hidden">
                            @csrf
                            @method('DELETE')
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-primary-800">
                                    Halaman ini menampilkan detail lengkap dari kategori pelanggan yang dipilih. Anda dapat mengedit atau menghapus data melalui tombol aksi di samping.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-2">
                        <div class="flex justify-between items-center py-2">
                            <span class="text-sm text-gray-600">Dibuat sejak</span>
                            <span class="font-medium text-gray-900">{{ $kategori->created_at->diffForHumans() }}</span>
                        </div>
                        <div class="border-t border-gray-200"></div>
                        <div class="flex justify-between items-center py-2">
                            <span class="text-sm text-gray-600">Update terakhir</span>
                            <span class="font-medium text-gray-900">{{ $kategori->updated_at->diffForHumans() }}</span>
                        </div>
                    </div>
                </div>
            </div>
