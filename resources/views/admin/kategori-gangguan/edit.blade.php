<x-layout>
    <div class="container mx-auto p-6 max-w-2xl" x-data="{ 
        ...
        hasChanges: false,
        originalData: {
            nama_gangguan: '{{ $kategoriGangguan->nama_gangguan }}',
            deskripsi: '{{ $kategoriGangguan->deskripsi }}'
        },
        checkChanges() {
            const currentNama = this.$refs.namaInput.value;
            const currentDesc = this.$refs.descInput.value;
            this.hasChanges = currentNama !== this.originalData.nama_gangguan || 
                            currentDesc !== this.originalData.deskripsi;
        },
        submitForm() {
        ...
        <div class="mb-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h1 class="text-3xl font-bold text-gray-900">Edit Kategori Gangguan</h1>
                    <p class="text-gray-600 mt-1">Perbarui informasi kategori gangguan yang dipilih</p>
                </div>
            </div>
        </div>
        ...
        <div x-show="showConfirmModal" 
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6"
                    ...
                    <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menyimpan perubahan pada kategori gangguan ini?</p>
        ...
        <div class="card">
            ...
            <form x-ref="mainForm" 
                  action="{{ route('kategori_gangguan.update', $kategoriGangguan->id) }}" 
                  method="POST" 
                ...
                <div class="card-body space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  placeholder="Jelaskan detail tentang kategori gangguan ini...">{{ old('deskripsi', $kategoriGangguan->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="form-error">
                                <svg class="inline w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                        ...
                        @enderror
                        <p class="text-sm text-gray-500 mt-1">Perbarui penjelasan detail mengenai kategori ini (opsional)</p>
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <ul class="mt-2 text-sm space-y-1">
                                    <li>• Dibuat: {{ $kategoriGangguan->created_at->format('d M Y, H:i') }}</li>
                                    <li>• Terakhir Diupdate: {{ $kategoriGangguan->updated_at->format('d M Y, H:i') }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="flex justify-between items-center">
                        <button type="button"
                                @click="hasChanges ? showCancelModal = true : window.location.href = '{{ route('kategori_gangguan.index') }}'"
                        ...
                        <div class="flex space-x-3">
                            <a href="{{ route('kategori_gangguan.show', $kategoriGangguan->id) }}"
